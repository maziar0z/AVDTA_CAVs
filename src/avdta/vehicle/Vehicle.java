...
public abstract class Vehicle implements Serializable, Comparable<Vehicle>
{
    ...
    // used for V/AV acting as moving bottleneck
    public int arr_time, enter_time, reservation_time;
    private List<Double> veh_control_speed;
    public double veh_speed;
    public int veh_linkTime;
    private HashMap<Double, Double> veh_list_pos;

    private MBData mbData;


    public static double vehicle_length = 19; //in feet
    ...
    {
        System.out.println("~~~ ENTERED LINK "+l.getId());
