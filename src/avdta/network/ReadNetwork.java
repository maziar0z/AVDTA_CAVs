...
public class ReadNetwork 
{
    ...
    public static final ExtendedType MOVING_BOTTLENECK = new ExtendedType(6, "CACC", LTM);
    ...
    /**
     * Reads node data from the given project and returns a set of nodes.
     *
     * @param project the project containing the node data
     * @return a set of nodes read from the project
    ...
    public Set<Link> readLinks(Project project) throws IOException
    {
        ...
        while(filein.hasNext())
        {
            ...
            else if(type/100 == LTM.getCode()/100)
            {
                ...
                else if(type == MOVING_BOTTLENECK.getCode())
                {
                    link = new MovingBottleneckLTMLink(id, source, dest, capacity, ffspd, w, jamd, length, numLanes);
                }
                else
                {
                    link = new LTMLink(id, source, dest, capacity, ffspd, w, jamd, length, numLanes);
